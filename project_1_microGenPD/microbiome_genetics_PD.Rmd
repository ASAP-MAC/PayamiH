...
n_clusters <- length(clusters_vs_dosages.lm.list)
indep_vars_HLA <- 2
indep_vars_SNCA <- 3

n_tests <- length(clusters_vs_dosages.lm.list) * indep_vars_HLA * indep_vars_SNCA
...
against 2 independent variants in the HLA gene locus and 3 variants in the 
SNCA locus, for a total of `r n_tests` tests. Then, we consider associations between clusters and variants with 
`Bonferroni p.adj < 0.1` as significant. All Cluster-variant associations 
discussed below are significant.
