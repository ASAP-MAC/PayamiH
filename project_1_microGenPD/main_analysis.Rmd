...
BioC_required_packages <- c("Maaslin2", "ANCOMBC", "biomaRt", "mia", "phyloseq", "microbiome")
...
cbind(c("Tot" = sum(nVars_by_genes_All), nVars_by_genes_All), 
  ...
  kableExtra::kbl(caption = "Variants testable in") %>% 
...
## Definition of microbiome subtypes based on Paper
...
spearman_correl_taxa_all <- cor(t(assay(wallenZD_data.mae, "metaphlan_RelAbund.se")), method = "spearman")
spearman_correl_taxa_ctrl <- cor(t(assay(wallenZD_data.mae, "metaphlan_RelAbund.se"))[,control_samples], method = "spearman")
spearman_correl_taxa_PD <- cor(t(assay(wallenZD_data.mae, "metaphlan_RelAbund.se"))[,PD_samples], method = "spearman")
spearman_correl_taxa
```
