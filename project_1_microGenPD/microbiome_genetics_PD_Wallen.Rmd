...
default_outdir <- "output_WallenZD_2022/"
...
cluster_sums.df <- left_join(biomarkers_medrxiv.df, 
  ...
  lapply(select, all_of(MultiAssayExperiment::colnames(WallenZD_2022_data.mae)[["metaphlan_RelAbund.se"]])) %>% 
  lapply(colSums) %>% 
