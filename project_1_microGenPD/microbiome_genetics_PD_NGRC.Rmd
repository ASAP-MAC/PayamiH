...
Below is the data sources for NGRC. This has been 
...
Genetic data have been retrieved with the protocol available in `00_NGRC_DataPreparation.html`.
In brief:
...
counts_tab <- t(assay(NGRC_data.mae, "metaphlan_Counts.se"))
