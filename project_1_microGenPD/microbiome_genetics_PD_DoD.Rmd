...
```{r}
prevalence_curve <- assay(DoD_data.mae, "metaphlan_Counts.se") %>% microbiome::prevalence() %>% sort(decreasing = TRUE) 
```
...
### GSEA on interaction effects from interaction model {.tabset}
...
### GSEA on variant-only effects from interaction model {.tabset}
...
### GSEA on variant effect in PD {.tabset}
