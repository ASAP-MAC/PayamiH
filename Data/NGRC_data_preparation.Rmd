...
# Microbiome data
mkdir -p Data/NGRC_shotgun/
cp /data/project/payami-lab/payamilab/cfm_shared/UAB515_NGRC_raw_data/ngrc* Data/NGRC_shotgun/
...
metaphlan_relab <- data.table::fread("/data/project/payami-lab/payamilab/cfm_shared/UAB515_NGRC_raw_data/ngrc_metaphlan_rel_ab.txt")
metaphlan_counts <- data.table::fread("/data/project/payami-lab/payamilab/cfm_shared/UAB515_NGRC_raw_data/ngrc_metaphlan_counts.txt")
...
# 2 - metadata
metadata <- data.table::fread("/data/project/payami-lab/payamilab/cfm_shared/UAB515_NGRC_raw_data/ngrc_metadata.txt") %>% 
  as.data.frame()
